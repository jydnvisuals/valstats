#' Valorant Champions Tour 2022 Champions Istanbul Data
#'
#' A list of 10 data frames containing team and player data from the Valorant
#' Champions Tour 2022 Champions Istanbul event. Data frames include assists,
#' economy, events, KDA, kills, matches, rounds, round player stats, teams, and
#' XvY data. Individual documentation for each included data frame is available.
#'
#'
